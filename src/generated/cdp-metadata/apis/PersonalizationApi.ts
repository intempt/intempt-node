...
export class PersonalizationApi extends runtime.BaseAPI {
     ...
     * chooseExperience
     */
    async chooseExperienceRaw(requestParameters: ChooseExperienceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        ...
        if (requestParameters.campaignId === null || requestParameters.campaignId === undefined) {
            throw new runtime.RequiredError('campaignId','Required parameter requestParameters.campaignId was null or undefined when calling chooseExperience.');
        }

        if (requestParameters.chooseExperience === null || requestParameters.chooseExperience === undefined) {
        ...
        const response = await this.request({
            path: `/v1/{orgName}/projects/{projectName}/personalization/campaigns/{campaignId}/experience-choose`.replace(`{${"orgName"}}`, encodeURIComponent(String(requestParameters.orgName))).replace(`{${"projectName"}}`, encodeURIComponent(String(requestParameters.projectName))).replace(`{${"campaignId"}}`, encodeURIComponent(String(requestParameters.campaignId))),
            method: 'POST',
     ...
     * chooseExperience
     */
    async chooseExperience(requestParameters: ChooseExperienceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.chooseExperienceRaw(requestParameters, initOverrides);
